            ...
            if gateway_cfg and isinstance(gateway_cfg, dict):
                ...
                if discord_cfg and isinstance(discord_cfg, dict):
                    ...
                    discord_keys = (
                        ...
                        "allowed_channel_ids",
                        "auto_fork_enabled",
                        "auto_fork_main_channel_notice",
                        "cost_summary_enabled",
                        "auto_fork_allowed_channel_ids",
                        "full_scrape_enabled",
                        ...
                        "full_scrape_thread_archived_limit",
                        "full_scrape_thread_parent_channels_per_tick",
                        "thread_seed_limit",
                        "backfill_enabled",
